package com.example.yjgdoodle.androids.utils;
...
public class EllipsizeUtils {
    ...
    private static void ellipsizeByKeywordInner(final TextView textView, String content, String keyword, boolean ignoreCase) {
